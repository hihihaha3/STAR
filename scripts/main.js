;(function (window) {
  ...
  function draw () {
    ...
    ctx.fillStyle = 'rgba(255, 255, 255, 0.9)'; // Tăng độ trong suốt để nhìn rõ hơn
ctx.shadowBlur = 10; // Thêm hiệu ứng phát sáng
    ctx.textBaseline = 'middle'
    ctx.fontWeight = 'bold'
    ctx.font = 'bold ' +  textSize + 'px \'SimHei\', \'Avenir\', \'Helvetica Neue\', \'Arial\', \'sans-serif\'';
